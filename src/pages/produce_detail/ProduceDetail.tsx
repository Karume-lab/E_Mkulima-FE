...
const ProduceDetail: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 flex flex-col items-center justify-center">
            <div className="bg-white shadow-md rounded-lg overflow-hidden max-w-4xl p-10 w-full mb-8">
                <img src={item.image} alt={`Image of ${item.name}`} className="w-full h-96 object-contain" />
                <h1 className="text-2xl text-center font-bold m-4 text-gray-800">{item.name}</h1>
            </div>
